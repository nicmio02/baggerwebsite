...
const i18n = {
  en: {
    ...
    text: {
      ...
      // Project builder blocks (CMS-authored project pages)
      "Locatie": "Location",
      "Periode": "Period",
      ...
      "Resultaten praktijktest": "Practical test results",
      "Wat doen we tijdens deze test?": "What do we do during this test?",
      "Opstap naar schaal": "Step up to scale",
      "Wat doet het consortium?": "What does the consortium do?",
      "Over deze praktijktest": "About this practical test",
      "Over de praktijktest": "About the practical test",
      "Wat hebben we gedaan?": "What did we do?",
      "Het probleem:": "The problem:",
      "Rol van Blauwe Bagger": "Blauwe Bagger's role",
      "Achtergrond": "Background",
      "OVER HET CBC": "ABOUT THE CBC",
      "VERONTREINIGINGSBEHEERSING": "CONTAMINATION MANAGEMENT",
      "Buiteneiland als onderdeel van": "Buiteneiland as part of",
      "duurzame gebiedsontwikkeling": "sustainable area development",
      "De wetenschap achter de extractie": "The science behind the extraction",
      "Elk metaal lost op bij een eigen pH-waarde": "Each metal dissolves at its own pH value",
      "circulaire verwaarding": "circular valorisation",
      "van baggerspecie in 2030": "of dredged sediment by 2030",
      "De maatschappelijke kosten van baggerspecie omzetten in maatschappelijke baten - en de wereldwijde positie van Nederland als baggerland versterken.":
        "Turning the societal costs of dredged sediment into societal benefits - and strengthening the Netherlands' global position as a leading dredging nation.",
      "Foto's van de praktijktest": "Photos of the practical test",
      "Aanpak": "Approach",
      "In voorbereiding": "In preparation",
      "Gepland": "Planned",
      "GEPLAND": "PLANNED",
      "Afgerond": "Completed",
      "Najaar 2026": "Autumn 2026",
      "Mei 2026": "May 2026",
      "Zomer 2026": "Summer 2026",
      "Provincie Zuid-Holland": "Province of Zuid-Holland",
